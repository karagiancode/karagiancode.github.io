...
const translations = {
  el: {
    ...
    "hero.desc": "Προπτυχιακός φοιτητής Μηχανικός Πληροφορικής με εμπειρία σε Python, embedded systems (ESP32, Raspberry Pi) και έρευνα σε computer vision με το ρομπότ Spot της Boston Dynamics. Αντιπρόεδρος IEEE — αναζητώ θέση πρακτικής ή Junior σε Software, Embedded, Robotics ή IoT.",
    ...
    "about.p1": "Είμαι προπτυχιακός φοιτητής <strong>Μηχανικός Πληροφορικής & Ηλεκτρονικών Συστημάτων</strong> στο Διεθνές Πανεπιστήμιο της Ελλάδος. Δουλεύω καθημερινά με <strong>Python, embedded systems και ρομποτική</strong>.",
    ...
    // Projects
    "proj.title": "Έργα",
    "proj.intro": "Επιλεγμένα projects από τις σπουδές μου, ερευνητική δραστηριότητα και προσωπικά έργα.",
    "proj.p1.title": "Multimodal Medical Image Classification",
    "proj.p1.desc": "Ακαδημαϊκή έρευνα: σύγκριση zero-shot LLaVA με fine-tuned ViT σε ταξινόμηση δερματολογικών εικόνων. Επίτευξη 78% accuracy έναντι 39%.",
    "proj.p2.title": "Spot — Vision & Mobile Manipulation",
    "proj.p2.desc": "Ερευνητικό έργο: επεξεργασία vision data του Spot, αυτόνομη πλοήγηση και pick & place στο NVIDIA Isaac Sim.",
    "proj.p3.title": "Fast-Food App",
    "proj.p3.desc": "Full-stack desktop εφαρμογή διαχείρισης παραγγελιών με persistent storage — εμπνευσμένη από την εμπειρία στα KFC.",
    "proj.p4.title": "Security System with ESP32",
    "proj.p4.desc": "Σύστημα ασφαλείας βασισμένο σε ESP32 — αισθητήρες, ειδοποιήσεις σε πραγματικό χρόνο και έλεγχος.",
    "proj.p5.title": "Data Recovery & Photo Organizer",
    "proj.p5.desc": "Python εργαλείο ανάκτησης και αυτόματης ταξινόμησης αρχείων μετά από data loss — ομαδοποίηση φωτογραφιών βάσει EXIF metadata.",
    "proj.p6.title": "Movie Planner",
    "proj.p6.desc": "Cloud-based watchlist app με real-time sync — προσωπική λίστα ταινιών με σύγχρονο GUI.",
    "proj.p7.title": "YouTube → MP3 Downloader",
    "proj.p7.desc": "Επιτραπέζια εφαρμογή για γρήγορη μετατροπή YouTube βίντεο σε MP3, με καθαρό GUI.",
    "proj.p8.title": "ItsMyBirthday",
    "proj.p8.desc": "Προσωπική ιστοσελίδα-πρόσκληση γενεθλίων — interactive front-end project.",
  ...
  en: {
    ...
    "hero.role": "Junior Software / Embedded Engineer · Robotics Researcher",
    "hero.desc": "Undergraduate Computer Engineering student with experience in Python, embedded systems (ESP32, Raspberry Pi) and research in computer vision with the Boston Dynamics Spot robot. IEEE Vice President — seeking internship or Junior position in Software, Embedded, Robotics or IoT.",
    "hero.cta1": "View my work",
    "hero.cta2": "Download CV",
    "hero.scroll": "scroll",

    "about.title": "About Me",
    "about.p1": "I am an undergraduate <strong>Computer & Electronic Systems Engineering</strong> student at the International Hellenic University. I work daily with <strong>Python, embedded systems and robotics</strong>.",
    ...
    "proj.title": "Projects",
    "proj.intro": "Selected projects from my studies, research work and personal endeavours.",
    "proj.p1.title": "Multimodal Medical Image Classification",
    "proj.p1.desc": "Academic research: zero-shot LLaVA vs fine-tuned ViT on dermatological image classification. Achieved 78% accuracy vs 39%.",
    "proj.p2.title": "Spot — Vision & Mobile Manipulation",
    "proj.p2.desc": "Research project: Spot vision data processing, autonomous navigation and pick & place in NVIDIA Isaac Sim.",
    "proj.p3.title": "Fast-Food App",
    "proj.p3.desc": "Full-stack desktop order management application with persistent storage — inspired by my KFC days.",
    "proj.p4.title": "Security System with ESP32",
    "proj.p4.desc": "ESP32-based security system — sensors, real-time alerts and control.",
    "proj.p5.title": "Data Recovery & Photo Organizer",
    "proj.p5.desc": "Python tool for file recovery and automatic organization after data loss — photo grouping by EXIF metadata.",
    "proj.p6.title": "Movie Planner",
    "proj.p6.desc": "Cloud-based watchlist app with real-time sync — personal movie list with a modern GUI.",
    "proj.p7.title": "YouTube → MP3 Downloader",
    "proj.p7.desc": "Desktop app for quick YouTube video to MP3 conversion, with a clean GUI.",
    "proj.p8.title": "ItsMyBirthday",
    "proj.p8.desc": "Personal birthday invitation website — interactive front-end project.",
